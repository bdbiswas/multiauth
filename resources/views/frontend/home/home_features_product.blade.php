...
<section class="section-padding pb-5">
   ...
   <a aria-label="Compare" class="action-btn"  id="" onclick="addToCompare(this.id)"><i class="fi-rs-shuffle"></i></a>

   <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="" onclick="productView(this.id)" ><i class="fi-rs-eye"></i></a>
                </div>
